...
{
    //Tavuk isimli Hayvan abstract sınıfını ve IHayvan arayüzünü kalıtım alan sınıf tanımlanıyor.
    class Tavuk : Hayvan, IHayvan
    {
        //Tavuk sınıfının değişkenleri tanımlanıyor.
        public int TavukSaniye { get; set; }
        public string TavukSesi { get; set; }
