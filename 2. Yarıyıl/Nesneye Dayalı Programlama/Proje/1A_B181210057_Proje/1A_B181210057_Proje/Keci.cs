...
{
    //Keci isimli Hayvan abstract sınıfını ve IHayvan arayüzünü kalıtım alan sınıf tanımlanıyor.
    class Keci : Hayvan, IHayvan
    {
        //Keci sınıfının değişkenleri tanımlanıyor.
        public int Kilogram { get; set; }
        public int KeciSaniye { get; set; }
        public string KeciSesi { get; set; }
